...
from .security import ALGORITHM, SECRET_KEY, require_roles
...
def boss_only(current_user=Depends(get_current_user)):
...
def boss_or_supervisor(current_user=Depends(get_current_user)):
