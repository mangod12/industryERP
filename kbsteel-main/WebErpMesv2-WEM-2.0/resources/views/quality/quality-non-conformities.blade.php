                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-8">
                              ...
                              <x-adminlte-input-switch id="type_update{{ $QualityNonConformity->id }}" name="type_update" data-on-text="{{ __('general_content.internal_trans_key') }}" data-off-text="{{ __('general_content.external_trans_key') }}" data-on-color="teal" is-checked="true" />
                              @else
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="code" id="code" placeholder="{{ __('general_content.external_id_trans_key') }}" value="{{ $codeNonConformity }}">
                </div>    
              </div>
              <div class="form-group col-md-4">
                <label for="label">{{__('general_content.label_trans_key') }}</label>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="label" id="label" placeholder="{{__('general_content.label_trans_key') }}" value="{{ $codeNonConformity }}" required>
                </div>
              </div>
              <div class="form-group col-md-4">
